...
export const badgeFrameSvg = (fullName: string): Buffer =>
  Buffer.from(`
    <svg width="1024" height="1280" viewBox="0 0 1024 1280" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="#111827" font-family="Liberation Sans" font-size="68" font-weight="800">
        ${nameText(fullName)}
      </g>
      <text x="512" y="1190" text-anchor="middle" fill="#111827" font-family="Liberation Sans" font-size="28" font-weight="700" letter-spacing="5">HACK THE ANDES</text>
    </svg>
  `);
